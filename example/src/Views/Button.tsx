  ...
  render(): React.ReactNode {
    ...
    return (
      <ScrollView keyboardShouldPersistTaps="handled" contentInsetAdjustmentBehavior="automatic" contentContainerStyle={styles.container} style={styles.view}>
        ...
        <Button style={itemStyle} disabled={disabled} text="Icon only mode" iconOnlyMode={true} kind="primary" icon={AddIcon} onPress={() => {console.info('Pressed icon')}} onLongPress={() => {console.info('Long pressed icon')}} />
        <Button style={itemStyle} disabled={disabled} text="Icon only mode" iconOnlyMode={true} kind="secondary" icon={AddIcon} onPress={() => {console.info('Pressed icon')}} onLongPress={() => {console.info('Long pressed icon')}} />
        <Button style={itemStyle} disabled={disabled} text="Icon only mode" iconOnlyMode={true} kind="tertiary" icon={AddIcon} onPress={() => {console.info('Pressed icon')}} onLongPress={() => {console.info('Long pressed icon')}} />
        <Button style={itemStyle} disabled={disabled} text="Icon only mode" iconOnlyMode={true} kind="ghost" icon={AddIcon} onPress={() => {console.info('Pressed icon')}} onLongPress={() => {console.info('Long pressed icon')}} />
        <Button style={itemStyle} disabled={disabled} text="Icon only mode" iconOnlyMode={true} kind="danger" icon={AddIcon} onPress={() => {console.info('Pressed icon')}} onLongPress={() => {console.info('Long pressed icon')}} />

...
export default class TestTopNavigationBar extends React.Component {
  ...
  private get additionalContent(): React.ReactNode {
    ...
    return (
      <>
        {showSearchBox && <Search value={searchValue} onChangeText={(value) => this.setState({ searchValue: value })} placeholder="Search input text" style={[styles.searchBox, showSwitch ? styles.switchDivider : undefined]} light={true} />}

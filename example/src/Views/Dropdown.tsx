...
import { Dropdown, DropdownItem, Text } from 'carbon-react-native';
  ...
  render(): React.ReactNode {
    ...
    return (
      <ScrollView keyboardShouldPersistTaps="handled" contentInsetAdjustmentBehavior="automatic" contentContainerStyle={styles.container} style={styles.view}>
        ...
        <View style={itemStyle}><Dropdown items={this.items} label="I should have everything" value={value4} helperText="I am helper text that is really long explaining how this input should work and stuff. I also override and set 220 px height" onChange={value => this.changeText('value4', value)} /></View>
        <View style={itemStyle}><Dropdown items={this.items} label="I am required" value={value5}  onChange={value => this.changeText('value5', value)} /></View>
        <View style={itemStyle}><Dropdown items={this.items} label="I am disabled" disabled={true} value={value6} onChange={value => this.changeText('value6', value)} /></View>
      </ScrollView>
    );
  }
}

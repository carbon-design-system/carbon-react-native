  ...
  render(): React.ReactNode {
    ...
    return (
      <ScrollView keyboardShouldPersistTaps="handled" contentInsetAdjustmentBehavior="automatic" contentContainerStyle={styles.container} style={styles.view}>
        ...
        <Checkbox style={styles.baseSpacing} checked={disabled} id="disable" onPress={(value) => this.setState({ disabled: value })} label="Make disabled" />
        <Tag style={styles.baseSpacing} title="Default with long text that is really long and probably going to wrap." disabled={disabled} onClosePress={showFilterClose ? () => Alert.alert('Pressed filter close', 'default') : undefined} />
